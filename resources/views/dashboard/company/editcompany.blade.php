            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <form action="{{ route('company.update', $company->uid) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6 space-y-6">
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">Edit Detail Perusahaan</h3>
                            <p class="mt-1 text-sm text-gray-500">Perbarui informasi perusahaan Anda di bawah ini.</p>
                        </div>
